...
namespace SpcDebug
{
	public static class Spc
	{
		...
		public static OpCode[] OpCodes = new OpCode[]
		{
			...
			new OpCode { Name = "OrImmediate8AddressBit", Type = InstructionType.DirectBitwiseImmediate },							// 0a
			...
			new OpCode { Name = "OrImmediate16AddressWithA", Type = InstructionType.Absolute },										// 0e
			...
			new OpCode { Name = "ShiftImmediate8PlusXAddressLeft", Type = InstructionType.DirectPlusX },		// 1b
			...
			new OpCode { Name = "AndAWithImmediate8Address", Type = InstructionType.Direct },		// 24
			...
			new OpCode { Name = "OrInverseImmediate8AddressBit", Type = InstructionType.DirectBitwiseImmediate },		// 2a
			...
			new OpCode { Name = "BranchToRelative8IfANotEqualToImmediate8Address", Type = InstructionType.DirectToDirect },		// 2e
			...
			new OpCode { Name = "AndAWithImmediate8PlusXPointer", Type = InstructionType.DirectPlusXPointer },		// 34
			...
			new OpCode { Name = "AndAWithImmediate8PointerPlusY", Type = InstructionType.ImmediateToDirect },		// 37
			new OpCode { Name = "AndImmediate8AddressWithImmediate8", Type = InstructionType.ImmediateToDirect },		// 38
			new OpCode { Name = "AndXAddressWithYAddress", Type = InstructionType.Stack },		// 39
			new OpCode { Name = "IncrementImmediate8Address16", Type = InstructionType.Direct },		// 3a
			new OpCode { Name = "RollImmediate8PlusXAddressLeft", Type = InstructionType.DirectPlusX },		// 3b
			new OpCode { Name = "RollALeft", Type = InstructionType.Stack },		// 3c
			...
			new OpCode { Name = "ExclusiveOrAWithXAddress", Type = InstructionType.Stack },		// 46
			new OpCode { Name = "ExclusiveOrAWithImmediate8PlusXPointer", Type = InstructionType.DirectPlusXPointer },		// 47
			...
			new OpCode { Name = "AndCarryWithImmediate8AddressBit", Type = InstructionType.DirectBitwiseImmediate },										// 4a
			...
			new OpCode { Name = "AndImmediate16AddressWithNotA", Type = InstructionType.Absolute },						// 4e
			...
			new OpCode { Name = "ExclusiveOrAWithImmediate8PlusXAddress", Type = InstructionType.DirectPlusX },		// 54
			...
			new OpCode { Name = "ExclusiveOrAWithImmediate8PointerPlusY", Type = InstructionType.DirectPointerPlusY },		// 57
			...
			new OpCode { Name = "ShiftImmediate8PlusXAddressRight", Type = InstructionType.DirectPlusX },		// 5b
			...
			new OpCode { Name = "CompareAToImmediate16Address", Type = InstructionType.Absolute },	// 65
			new OpCode { Name = "CompareAToXAddress", Type = InstructionType.Absolute },		// 66
			new OpCode { Name = "CompareAToImmediate8PlusXPointer", Type = InstructionType.DirectPlusXPointer },		// 67
			...
			new OpCode { Name = "AndCarryWithInverseImmediate8AddressBit", Type = InstructionType.DirectBitwiseImmediate },												// 6a
			...
			new OpCode { Name = "CompareAToImmediate8PlusXAddress", Type = InstructionType.DirectPlusX },		// 74
			...
			new OpCode { Name = "CompareAToImmediate8PointerPlusY", Type = InstructionType.DirectPointerPlusY },		// 77
			...
			new OpCode { Name = "RollImmediate8PlusXAddressRight", Type = InstructionType.DirectPlusX },		// 7b
			...
			new OpCode { Name = "ReturnFromInterrupt", Type = InstructionType.Stack },															// 7F
			...
			new OpCode { Name = "AddImmediate8PlusXPointerPlusCarryToA", Type = InstructionType.DirectPlusXPointer },		// 87
			new OpCode { Name = "AddImmediate8PlusCarryToA", Type = InstructionType.Immediate },		// 88
			new OpCode { Name = "AddImmediate8AddressPlusCarryToImmediate8Address", Type = InstructionType.DirectToDirect },		// 89
			new OpCode { Name = "ExclusiveOrCarryFlagWithImmediate8AddressBit", Type = InstructionType.DirectBitwiseImmediate },							// 8a
			...
			new OpCode { Name = "AddImmediate8PlusXAddressPlusCarryToA", Type = InstructionType.DirectPlusX },		// 94
			...
			new OpCode { Name = "AddImmediate8PointerPlusYPlusCarryToA", Type = InstructionType.DirectPointerPlusY },		// 97
			...
			new OpCode { Name = "SubtractImmediate8AddressFromYA", Type = InstructionType.Direct },		// 9a
			...
			new OpCode { Name = "SubtractXAddressPlusBorrowFromA", Type = InstructionType.Stack },		// A6
			new OpCode { Name = "SubtractImmediate8PlusXPointerPlusBorrowFromA", Type = InstructionType.DirectPlusXPointer },		// A7
			new OpCode { Name = "SubtractImmediate8PlusBorrowFromA", Type = InstructionType.Immediate },		// A8
			new OpCode { Name = "SubtractImmediate8AddressPlusBorrowFromImmediate8Address", Type = InstructionType.DirectToDirect },		// A9
			new OpCode { Name = "CopyImmediate8AddressBitToCarryFlag", Type = InstructionType.DirectBitwiseRelative },	// AA														// AA
			...
			new OpCode { Name = "SubtractImmediate8PlusXAddressPlusBorrowFromA", Type = InstructionType.DirectPlusX },		// B4
			...
			new OpCode { Name = "SubtractImmediate8PointerPlusYPlusBorrowFromA", Type = InstructionType.DirectPointerPlusY },		// B7
			...
			new OpCode { Name = "IncrementImmediate8PlusXAddress", Type = InstructionType.DirectPlusX },		// bb
			...
			new OpCode { Name = "CopyAToImmediate8PlusXPointer", Type = InstructionType.DirectPlusXPointer },			// c7
			...
			new OpCode { Name = "CopyCarryFlagToImmediate8AddressBit", Type = InstructionType.DirectBitwiseImmediate },	// ca
			...
			new OpCode { Name = "BranchToRelative8IfANotEqualToImmediate8PlusXAddress", Type = InstructionType.DirectToDirect },		// de
			...
			new OpCode { Name = "ToggleImmediate8AddressBit", Type = InstructionType.DirectBitwiseImmediate },				// ea
